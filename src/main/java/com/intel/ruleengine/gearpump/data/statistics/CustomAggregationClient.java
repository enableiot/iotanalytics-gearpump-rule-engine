...
@SuppressWarnings({"checkstyle:magicnumber", "checkstyle:illegalcatch", "checkstyle:illegalthrows",
        "checkstyle:visibilitymodifier", "checkstyle:avoidinlineconditionals", "checkstyle:anoninnerlength",
        "checkstyle:booleanexpressioncomplexity", "checkstyle:innerassignment", "PMD"})
public class CustomAggregationClient implements Closeable {

    private final Connection connection;


    public CustomAggregationClient(Connection connection) {
     ...
     * @throws Throwable
     */
    public <R, S, P extends Message, Q extends Message, T extends Message> double std(final TableName tableName, ColumnInterpreter<R, S, P, Q, T> ci,
