...
class BasicRuleComponentsStorage extends RuleComponentsStorage {

    BasicRuleComponentsStorage(RuleConditionsRepository ruleConditionsRepository, List<RulesWithObservation> rulesWithObservation) {
